      ...
      <div className="main-container space-y-14 md:space-y-[70px]">
        <div className="space-y-3 text-center max-w-[780px] mx-auto">
          ...
          <RevealAnimation delay={0.3}>
            <h2>Fascinante Digital is defining the future landscape of business.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.4}>
            <p>
              In a rapidly evolving digital world, Fascinante Digital stands at the forefront of innovation, transforming how
