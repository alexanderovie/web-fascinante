...
const GdprContent = () => {
  ...
  const dataManagementItems: ListItem[] = [
    ...
    {
      id: 'data-deletion',
      text: 'To request a complete data deletion or data export, simply send an email to: support@fascinante digital.com',
    },
  ];
                    ...
                    <span className="text-tagline-1 text-secondary/60 dark:text-accent/60">
                      {item.id === 'data-deletion' ? (
                        <>
                          ...
                          <span className="text-secondary dark:text-accent">support@fascinante digital.com</span>
                        </>
                      ) : (
                        item.text
                      )}
