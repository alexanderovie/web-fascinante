...
const rightsSection: ListSection = {
  ...
  items: [
    ...
    {
      content:
        'If you wish to exercise these rights, please contact us at <a href="mailto:support@fascinante digital.com" class="text-secondary dark:text-accent">support@fascinante digital.com</a>',
    },
  ],
};
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-2">
              ...
              <p>
                ...
                <Link href="https://fascinante digital.com" className="text-secondary dark:text-accent">
                  https://fascinante digital.com
                </Link>
                (the &quot;Site&quot;).
              </p>
            </div>
