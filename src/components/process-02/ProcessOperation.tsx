            ...
            <div className="space-y-5">
              <RevealAnimation delay={0.5}>
                <div className="sm:max-w-[596px] lg:mx-0 mx-auto sm:py-6 py-5 sm:px-[34px] px-7 bg-background-3 dark:bg-background-7 sm:rounded-[20px] rounded-2xl flex items-start sm:gap-[22px] gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-lg font-semibold leading-[27px] text-secondary dark:text-accent">
                      Choose domain
                    </h3>
                    <p>
              ...
              <RevealAnimation delay={0.7}>
                <div className="sm:max-w-[596px] lg:mx-0 mx-auto sm:py-6 py-5 sm:px-[34px] px-7 bg-background-3 dark:bg-background-7 sm:rounded-[20px] rounded-2xl flex items-start sm:gap-[22px] gap-4">
                  ...
                  <div className="space-y-1">
                    <h3 className="text-lg font-semibold leading-[27px] text-secondary dark:text-accent">Make payment</h3>
                    <p>
