...
const NavbarTwo: FC<NavbarTwoProps> = ({ className, megaMenuColor, btnClassName, dict }) => {
        ...
        <div
          ...
          <nav className="hidden items-center xl:flex">
            <ul className="flex items-center gap-6">
              {getNavigationItems(dict || { navigation: { home: 'Home', about: 'About', services: 'Services', blog: 'Blog', contact: 'Contact' } }).map((item) => {
